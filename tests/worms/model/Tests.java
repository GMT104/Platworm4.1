...
public class Tests {
	...
	public void testDensity() {
		Worm testWorm = new Worm(0, 0, 0, 1, "James O'Hare", true, world,null);
	...
	public void testConstructorLegalCase3() throws ModelException {
		Worm testWorm = new Worm(10, 10, 3 * Math.PI, 10, "James 007", true,
				world,null);
		assertEquals(10, testWorm.getCoordinateX(), EPS);
		assertEquals(10, testWorm.getCoordinateY(), EPS);
		assertEquals(Math.PI, testWorm.getDirection(), EPS);
		assertEquals(10, testWorm.getRadius(), EPS);
	...
	public void testConstructorIllegalCaseCoordinateXIsNan()
		...
		new Worm(Double.NaN, 0, 0, 1, "Bob", true, world,null);
	}

	@Test(expected = ModelException.class)
	public void testConstructorIllegalCaseCoordinateYIsNan()
			throws ModelException {
		new Worm(0, Double.NaN, 0, 1, "Bob", true, world,null);
	}

	@Test
	public void testConstructorIllegalCaseCoordinateXIsNotInMap()
			throws ModelException {
		Worm testWorm = new Worm(25, 0, 0, 1, "Bob", true, world,null);
	...
	public void testConstructorIllegalCaseCoordinateYIsNotInMap()
			throws ModelException {
		Worm testWorm = new Worm(2, -5, 0, 1, "Bob", true, world,null);
		assertFalse(testWorm.getStatus());
	}
	...
	public void testConstructorIllegalCaseRadiusSmallerThanMinimum()
			throws ModelException {
		new Worm(0, 0, 0, 0.1, "Bob", true, world,null);
	}

	@Test(expected = ModelException.class)
	public void testConstructorIllegalCaseRadiusIsNan() throws ModelException {
		new Worm(0, 0, 0, Double.NaN, "Bob", true, world,null);
	}

	@Test(expected = ModelException.class)
	public void testConstructorIllegalCaseRadiusIsMaxInteger()
			throws ModelException {
		new Worm(0, 0, 0, Integer.MAX_VALUE, "Bob", true, world,null);
	}

	@Test
	public void testChangeRadiusLegalCase() {
		Worm testWorm = new Worm(10.0, 5.0, Math.PI, 1, "Bob", true, world,null);
	...
	public void testConstructorIllegalCaseNameSingleLetter()
			throws ModelException {
		new Worm(10.0, 20.0, Math.PI, 1.0, "J", true, world,null);
	}

	@Test(expected = ModelException.class)
	public void testConstructorIllegalCaseNameNoStartingCapital()
			throws ModelException {
		new Worm(10.0, 1.0, Math.PI, 1.0, "james", true, world,null);
	}

	@Test(expected = ModelException.class)
	public void testConstructorIllegalCaseNameIllegalSymbol()
			throws ModelException {
		new Worm(10.0, 5.0, Math.PI, 1.0, "J*", true, world,null);
	}
	...
	public void testIsAlive() {
		Worm testWorm = new Worm(12.0, 4.0, Math.PI / 4, 1, "Bob", true, world,null);
		new Worm(10.0, 4.0, Math.PI, 1, "Bob", true, world,null);
		world.addAsGameObject(testWorm);
	...
	public void testFall() {
		Worm testWorm = new Worm(12.0, 10.0, Math.PI / 4, 1, "Bob", true, world,null);
		world.addAsGameObject(testWorm);
	...
	public void testMoveVertical(){
		Worm testWorm = new Worm(12.0, 3.05, Math.PI/2.0, 1, "Bob", true, world,null);
		testWorm.move();
	...
	public void testMoveHorizontal(){
		Worm testWorm = new Worm(12.0, 3.05,0.0, 1, "Bob", true, world,null);
		testWorm.move();
	...
	public void testMoveToTheLeftAndUp(){
		 Worm testWorm = new Worm(12.0, 3.0,Math.PI/2.0 + Math.PI/5.0, 1, "Bob", true, world,null);
		 testWorm.move();
		 testWorm.fall();
	 ...
	 public void testMoveIllegalCaseCannotMoveInsufficientActionPoints() throws ModelException {
		 Worm testWorm = new Worm(12.0, 3.05, Math.PI/2.0+Math.PI/8.0, 1, "Bob", true, world,null);
		 new Worm(12.0, 3.05, Math.PI/2.0+Math.PI/8.0, 1, "Bob", true, world,null);
	 ...
	 public void testMoveIllegalCaseCannotMoveIllegalDirection() throws ModelException {
		 Worm testWorm = new Worm(12.0, 3.0, -Math.PI/2.0, 1, "Bob", true, world,null);
		 testWorm.move();
	 }
	...
	public void testJumpLegalCaseFlatJump() {
		Worm testWorm = new Worm(12.0, 4.0, Math.PI / 4, 1, "Bob", true, world,null);
		world.addAsGameObject(testWorm);
		Worm testWorm2 = new Worm(12.0, 4.0, Math.PI / 4, 1, "Bob", true, world,null);
	...
	public void testJumpLegalCaseToALowerLevel() {
		Worm testWorm = new Worm(8.0, 11.0, Math.PI / 4, 1, "Bob", true, world2,null);
	...
	public void testJumpLegalCaseAgainstWall() {
		Worm testWorm = new Worm(12.794288248, 3.0, 3*Math.PI / 4, 1, "Bob", true, world2,null);
		testWorm.jump(Math.pow(10, -4));
		/*
	...
	public void testJumpIllegalCaseInvalidActionPoints() throws ModelException {
		Worm testWorm = new Worm(10.0, 4.0, Math.PI, 1, "Bob", true, world,null);
		new Worm(10.0, 4.0, Math.PI, 1, "Bob", true, world,null);
		testWorm.fall();
		testWorm.jump(Math.pow(10, -4));
		testWorm.jump(Math.pow(10, -4));
